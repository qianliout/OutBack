---
title: "第十章 智能体通信协议"
source: "https://datawhalechina.github.io/hello-agents/#/./chapter10/%E7%AC%AC%E5%8D%81%E7%AB%A0%20%E6%99%BA%E8%83%BD%E4%BD%93%E9%80%9A%E4%BF%A1%E5%8D%8F%E8%AE%AE"
author:
published:
created: 2026-01-28
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-1.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-2.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-3.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-1.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-4.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-5.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-2.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-6.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-3.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-4.png)
...
前面我们学习了如何直接使用 MCP 客户端。但在实际应用中，我们更希望让智能体 **自动** 调用 MCP 工具，而不是手动编写调用代码。HelloAgents 提供了 `MCPTool` 包装器，让 MCP 服务器无缝集成到智能体的工具链中。
...
MCP 协议的一个巨大优势是 **丰富的社区生态** 。Anthropic 和社区开发者已经创建了大量现成的 MCP 服务器，涵盖文件系统、数据库、API 服务等各种场景。这意味着你不需要从零开始编写工具适配器，可以直接使用这些经过验证的服务器。
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-5.png)

表 10.6 社区热门 MCP 服务器

![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-6.png)
...
A2A 协议采用点对点（P2P）架构（网状拓拓），允许智能体直接通信，从根本上解决了上述问题。它的核心是 **任务（Task）** 和 **工件（Artifact）** 这两个抽象概念，这是它与 MCP 最大的区别，如表 10.7 所示。

表 10.7 A2A 核心概念

![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-7.png)

为实现对协作过程的管理，A2A 为任务定义了标准化的生命周期，包括创建、协商、代理、执行中、完成、失败等状态，可见图 10.7。

![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-7.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-8.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-table-8.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-9.png)
...
![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-10.png)
...
当然，这里只是举例，还有更多的用法可以自行探索，下图 10.11 展示了当 MCP 工具发布成功会包含的信息，显示服务的名称“天气”，其唯一标识符 `@jjyaoao/weather-mcp-server` ，以及状态信息。Tools 区域就是我们刚刚实现的方法，Connect 区则提供了连接和使用此服务所需的技术信息，包括服务的 **接入 URL 地址** 和多种语言/环境下的 **配置代码片段** 。如果想要更加深入了解可以点击这个 [链接](https://smithery.ai/server/@jjyaoao/weather-mcp-server) 。

![](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/10-figures/10-11.png)
...
2. **深入学习** ：
	- 阅读 MCP 官方文档： [https://modelcontextprotocol.io](https://modelcontextprotocol.io/)
	- 阅读 A2A 官方文档： [https://a2a-protocol.org/latest/](https://a2a-protocol.org/latest/)
	- 阅读 ANP 官方文档： [https://agent-network-protocol.com/guide/](https://agent-network-protocol.com/guide/)
3. **参与社区** ：
	- 向社区贡献新的 MCP 服务
	- 分享个人开发的智能体实现案例
...
\[1\] Anthropic. (2024). *Model Context Protocol*. Retrieved October 7, 2025, from [https://modelcontextprotocol.io/](https://modelcontextprotocol.io/)

\[2\] The A2A Project. (2025). *A2A Protocol: An open protocol for agent-to-agent communication*. Retrieved October 7, 2025, from [https://a2a-protocol.org/](https://a2a-protocol.org/)

\[3\] Chang, G., Lin, E., Yuan, C., Cai, R., Chen, B., Xie, X., & Zhang, Y. (2025). *Agent Network Protocol technical white paper*. arXiv. [https://doi.org/10.48550/arXiv.2508.00007](https://doi.org/10.48550/arXiv.2508.00007)
