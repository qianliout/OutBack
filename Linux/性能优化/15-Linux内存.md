...
- 我来也: [D15打卡]linux的内存跟windows的很不一样。类linux的系统会尽量使用内存缓存东西，...
- JohnT3e: 目前我配合使用《Operating System Concepts》这本书学习此专栏，也是一个不错的...
- 虎虎❤️: 请教老师几个问题1. 当内存紧张时，系统通过三种机制回收内存。第二种换页比较好理解， 但是第一种LR...

### 技术讨论

- 赵强强: 倪老师，“Operating Systems Design and Implementation”里...
- Griffin: hmmm，我要提问。老师，我的开发机是macbook。内存是16G。但是经常出现已12G，swap用...
- 赵强强: 倪老师，如果进程间的虚拟内存空间独立，每个进程又有自己的页表，那么进程怎么获知其他进程占用的物理内存...

### 实践经验

- 圣域烈焰: 请教一个问题，使用free命令的时候，看到的buffer、cache和shared有什么区别？...

### 问题求助

- espzest: 用户空间malloc不会使用slab机制吧，slab是内核空间的，对不？...
