...
- 我来也: [D19打卡]很遗憾,还未遇到过swap导致的性能问题.刚买电脑时,512M内存要四百多,可是当时也...
- 2xshu: 非常感谢老师的课程。让我受益匪浅。老师，我还有两个问题，想请教。1：zone_reclaim_mod...

### 技术讨论

- 石头: hadoop集群服务器一般是建议关闭swap交换空间，这样可提高性能。在什么情况下开swap、什么情...
- 路过: 老师，前面你写只有当剩余内存落在页最小阈值和页低阈值中间，才开始回收内存。后面讲即使把 swappi...
- 划时代: 最近碰到内存打满，瞬间导致系统负载和CPU使用率打满的情况。...

### 问题求助

- bob: swappiness=0Kernel version 3.5 and newer: disables...
- Days: 我们公司处理嵌入式系统都是关闭swap分区，具体不知道什么原因？...
- DJH: 倪老师，请教一下，Linux下怎么关闭SWAP功能？直接不分配SWAP卷（或者分区、文件），还是通过...
